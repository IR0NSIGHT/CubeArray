 ...
 *
 * <p>Call {@link #init()} once at application startup (before anything else).
 * It configures the JUL root logger with:
 * <ul>
 *   <li>A {@link ConsoleHandler} at {@code WARNING} and above (keeps existing console behaviour).</li>
 *   <li>A rolling {@link FileHandler} at {@code INFO} and above writing to
 *       {@code <installPath>/logs/cubearray%g.log} (5 MB per file, 3 rotations, append mode).</li>
 * </ul>
 *
...
public final class AppLogger {
    ...
    /**
     * Initialises JUL logging. Must be called once before any logger is used.
    ...
    public static synchronized void init() {
        ...
        try (InputStream is = AppLogger.class.getClassLoader()
