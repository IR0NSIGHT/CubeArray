...
public enum CaColumn {
  ...
  LAST_CHANGED(
      "Last Changed",
      Date.class,
      FileTableModel.dateRenderer,
      "Date when the file was last modified",
      135),
  FILE_TYPE(
      "Schematic Type",
      String.class,
      FileTableModel.defaultRenderer,
  ...
  DIMENSION_WIDTH(
      "Width",
      Integer.class,
      FileTableModel.dimensionRenderer,
      "Width of the schematic (meters)",
      40),
  DIMENSION_HEIGHT(
      "Height",
      Integer.class,
      FileTableModel.dimensionRenderer,
      "Height of the schematic (meters)",
      45),
  DIMENSION_DEPTH(
      "Depth",
      Integer.class,
      FileTableModel.dimensionRenderer,
      "Depth of the schematic (meters)",
      40),
  DIMENSION_DIAGONAL(
      "Diagonal",
      Integer.class,
      FileTableModel.dimensionRenderer,
      "Diagonal of the schematic from edge to edge (meters)",
      45),
  OFFSET(
      "Offset",
      String.class,
      FileTableModel.defaultRenderer,
      "WorldEdit offset / minimum corner (x, y, z)",
      90),
  MIN_POS(
      "Min Pos",
      String.class,
      FileTableModel.defaultRenderer,
      "Minimum block position (x, y, z)",
      90),
  MAX_POS(
      "Max Pos",
      String.class,
      FileTableModel.defaultRenderer,
      "Maximum block position (x, y, z)",
      90),
  ...
  BLOCKS(
      ...
      500),
  ENTITIES(
      "Entities", List.class, FileTableModel.stringListRenderer, "Entities in the schematic", 200),
  TILE_ENTITIES(
      "Tile Entities",
      List.class,
      FileTableModel.stringListRenderer,
  ...
  ATTRIBUTES(
      "Attributes",
      HashMap.class,
      FileTableModel.attributesRenderer,
      "NBT Attributes attached to the schematic",
      100),
  LOADING_STATE(
      "State",
      String.class,
  ...
  CaColumn(
      String name,
      Class<?> clazz,
      FileTableModel.StringConverter renderer,
      String tooltip,
      int defaultWidth) {
