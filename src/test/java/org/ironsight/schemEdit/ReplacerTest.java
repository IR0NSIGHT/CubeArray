...
public class ReplacerTest {
    ...
    public void oakHangingSign_toSpruceWood() throws NotFoundExc {
        assertEquals("spruce_hanging_sign", replacer.replaceBlockByCategory("oak_hanging_sign", "spruce_wood"));
    }
    ...
    public void strippedOakLog_toSpruceTree() throws NotFoundExc {
        assertEquals("stripped_spruce_log", replacer.replaceBlockByCategory("stripped_oak_log", "spruce_tree"));
    }
    ...
    public void infestedCobblestone_toStone() throws NotFoundExc {
        assertEquals("infested_stone", replacer.replaceBlockByCategory("infested_cobblestone", "stone"));
    }
    ...
    public void chiseledSandstone_toCutSandstone() throws NotFoundExc {
        assertEquals("cut_sandstone", replacer.replaceBlockByCategory("chiseled_sandstone", "cut_sandstone"));
    }

    @Test
    public void smoothSandstoneSlab_toCutSandstone() throws NotFoundExc {
        assertEquals("cut_sandstone_slab", replacer.replaceBlockByCategory("smooth_sandstone_slab", "cut_sandstone"));
    }
    ...
    public void copperBlock_toExposedCopper() throws NotFoundExc {
        assertEquals("exposed_copper", replacer.replaceBlockByCategory("copper_block", "exposed_copper"));
    }

    @Test
    public void copperGrate_toExposedCopper() throws NotFoundExc {
        assertEquals("exposed_copper_grate", replacer.replaceBlockByCategory("copper_grate", "exposed_copper"));
    }
    ...
    public void blockNotInAnyCategory_throws() {
        assertThrows(NotFoundExc.class,
                () -> replacer.replaceBlockByCategory("air", "stone"));
    }

    @Test
    public void unknownCategory_throws() {
        assertThrows(NotFoundExc.class,
                () -> replacer.replaceBlockByCategory("oak_planks", "nonexistent"));
    }
