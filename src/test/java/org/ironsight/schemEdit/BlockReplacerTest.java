...
public class BlockReplacerTest {
    ...
    public void replaceRedSandstoneWithCobblestone() throws Exception {
        ...
        assertTrue("source must contain red_sandstone",
                BlockReplacer.getPalette(source).contains("minecraft:red_sandstone"));

        Schematic result = BlockReplacer.replace(source,
                Map.of("minecraft:red_sandstone", "minecraft:cobblestone"));
    ...
    public void writeAndReloadProducesCorrectPalette() throws Exception {
        ...
        assertFalse("red_sandstone should be gone after reload",  palette.contains("minecraft:red_sandstone"));
